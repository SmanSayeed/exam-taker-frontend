...
const SubjectForQuestionPage = () => {
    const { data: subjectData, isLoading, isSuccess, refetch } = useGetQuestionsCategoryQuery("subject");
...
export default SubjectForQuestionPage