...
const LessonForQuestionPage = () => {
    const { data: lessonData, isLoading, isSuccess, refetch } = useGetQuestionsCategoryQuery("lesson");
            ...
            <Layout>
                ...
                <Layout.Body>
                    ...
                    <div className='-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-x-12 lg:space-y-0'>
                        {
                            isLoading ? <Loading /> : (
                                isSuccess && lessonData?.data?.data && <DataTable data={lessonData?.data?.data} columns={columns} />
                            )
                        }
                    </div>
                </Layout.Body>
