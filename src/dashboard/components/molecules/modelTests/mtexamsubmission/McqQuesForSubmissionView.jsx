        ...
        <Card className="p-4 relative group shadow-md my-3 hover:shadow-lg duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {mcq_options?.map((option, index) => {
                    ...
                    const isSubmittedOptionCorrect = student_answer?.is_correct;
                    const isSubmitted = option?.mcq_option_serial === student_answer?.submitted_option;
